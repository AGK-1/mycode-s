...
// mehsul sayini local storageye elazve et
if(!localStorage.getItem('goods')) {
  localStorage.setItem('goods', JSON.stringify([]))
}

// yeni mehsulu yadda saxla
document.querySelector('button.add_new').addEventListener('click', function(e) {
  ...
  if(name && price && count) {
    ...
    Swal.fire({
      icon: 'error',
      title: 'Sehv oldu',
      text: 'xahis edirik hamisini doldurun!',
    })
  }
})
...
document.querySelector('.list').addEventListener('click', function(e) {  
  ...
  Swal.fire({
    title: 'Diqqet!',
    text: "Silmek istediyinizden eminsinizmi?",
    icon: 'warning',
